"""Global settings shared by every company (OpenRouter connection, pricing).

Per-company settings (name, mission, model override, budget) live on the
company itself — see PATCH /api/companies/{id}.
"""
